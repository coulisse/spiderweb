...
function buildHtmlPlots(selector,data) {
	...
	contBandsActivity$.append($('<img class="img-fluid" src="/static/plots/'+data['propagation_heatmaps_AS']+'.png" alt="propatation heatmap AF" srcset="/static/plots/'+data['propagation_heatmaps_AS']+'.svg">'));
